...
<body data-base-path="{{ url('/') }}" class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">
    <!-- Header -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            @if(isset($parent_page))
                <!-- Single parent page -->
                    <li><a href="{{ isset($parent_path)?url($parent_path): url('/backend')}}"></i> {{$parent_page}}</a></li>
            @endif

            @if(isset($parent_pages))
                <!-- Multiple parent pages -->
                    @foreach($parent_pages as $row)
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.delete_row').click(function () {
                ...
                var id = $('#row_id').val();
                var url = $('body').data('base-path')+'/'+$('#path').val()+id;
